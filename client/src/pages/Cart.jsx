...
const Cart = () => {
    const {products, currency, cartItems, removeFromCart, updateCartItems, getCartCount, getCartAmount, navigate, axios, user, setCartItems } = useAppContext(); 
    ...
    const getCart = ()=>{  //get items in cart
        let tempArray = []
